...
import { Plus, Sparkles, Filter, Loader2, Calendar, BarChart3, Image as ImageIcon, Video, X, ChevronRight, Check, Eye, MousePointer, Archive, Send, Edit3, DollarSign, RefreshCw, Wand2, Instagram, Facebook, Twitter, Linkedin, Youtube, Clock, Heart, MessageCircle, Share2, Zap, Download, FileText, ImageDown, ChevronDown, Trash2, Save, AlertCircle } from 'lucide-react';
import { 
                ...
                <div className="flex items-center gap-1">
                    ...
                    <span>
                      {campaign.status === 'posted' && campaign.publishedAt
                        ...
                        : `${campaign.scheduling.startDate} at ${campaign.scheduling.postTime}`
                      }
                    </span>
                </div>
            </div>
