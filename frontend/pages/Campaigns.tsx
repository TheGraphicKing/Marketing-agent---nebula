...
const Campaigns: React.FC = () => {
  ...
  const deleteSelectedCampaigns = async () => {
    ...
    if (!confirm(`Are you sure you want to delete ${selectedCampaignIds.size} campaign(s)? This action cannot be undone.`)) return;
        ...
        <div className="animate-in fade-in duration-500">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <button
              ...
              className={`group relative rounded-2xl border p-6 text-left transition-all duration-300 hover:scale-[1.02] hover:shadow-xl ${
                isDarkMode
                  ? 'bg-[#161b22] border-slate-700/50 hover:border-purple-500/50'
                  : 'bg-white border-slate-200 hover:border-purple-300'
              }`}
            >
              <div className="p-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl w-fit mb-4 shadow-lg shadow-purple-500/20">
                <Sparkles className="w-6 h-6 text-white" />
              </div>
              <h3 className={`text-lg font-bold mb-2 ${theme.text}`}>Create Campaign</h3>
            ...
            {/* Create a Post */}
            <button
              onClick={() => {/* TODO: Create a Post flow */}}
              className={`group relative rounded-2xl border p-6 text-left transition-all duration-300 hover:scale-[1.02] hover:shadow-xl ${
                isDarkMode
            ...
            >
              <div className="p-3 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl w-fit mb-4 shadow-lg shadow-blue-500/20">
                <PenLine className="w-6 h-6 text-white" />
              </div>
              <h3 className={`text-lg font-bold mb-2 ${theme.text}`}>Create a Post</h3>
              <p className={`text-sm leading-relaxed ${theme.textSecondary}`}>
                Write and design a single post with AI assistance
              </p>
              <div className={`mt-4 flex items-center gap-1.5 text-xs font-medium ${
            ...
            >
              <div className="p-3 bg-gradient-to-br from-[#ffcc29] to-[#ffa500] rounded-xl w-fit mb-4 shadow-lg shadow-[#ffcc29]/20">
                <ImageIcon className="w-6 h-6 text-black" />
              </div>
              <h3 className={`text-lg font-bold mb-2 ${theme.text}`}>Create using Template</h3>
              <p className={`text-sm leading-relaxed ${theme.textSecondary}`}>
            ...
            >
              <div className="p-3 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl w-fit mb-4 shadow-lg shadow-green-500/20">
                <Send className="w-6 h-6 text-white" />
              </div>
              <h3 className={`text-lg font-bold mb-2 ${theme.text}`}>Upload & Publish</h3>
              <p className={`text-sm leading-relaxed ${theme.textSecondary}`}>
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        {/* New Campaign Button with Type Selector */}
        <div className="relative">
          <button 
            onClick={() => setShowCampaignTypeSelector(!showCampaignTypeSelector)}
          ...
          >
            ...
            New Campaign
            <ChevronDown className={`w-4 h-4 transition-transform ${showCampaignTypeSelector ? 'rotate-180' : ''}`} />
          </button>
