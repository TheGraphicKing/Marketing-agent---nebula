                  ...
                  return (
                    ...
                    >
                      <div className={`p-3 rounded-full mb-4 ${isDarkMode ? 'bg-slate-800' : 'bg-slate-200'}`}>
                        <RefreshCw className={`w-8 h-8 ${isDarkMode ? 'text-slate-500' : 'text-slate-400'} ${regeneratingIndex === idx ? 'animate-spin' : ''}`} />
                      </div>
