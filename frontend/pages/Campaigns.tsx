    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {campaigns.map((campaign) => (
          <CampaignCard key={campaign._id} campaign={campaign} isDarkMode={isDarkMode} theme={theme} onPost={openPostModal} />
        ))}
      </div>
    );
  };
...
const CampaignCard: React.FC<{ campaign: Campaign; isDarkMode: boolean; theme: ReturnType<typeof getThemeClasses>; onPost?: (campaign: Campaign) => void }> = ({ campaign, isDarkMode, theme, onPost }) => (
